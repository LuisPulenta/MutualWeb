...
namespace MutualWeb.Frontend.Pages.Auth
{
    public partial class RecoverPassword
    {
        ...
        private async Task SendRecoverPasswordEmailTokenAsync()
        {
            ...
            loading = false;
            await SweetAlertService.FireAsync("Confirmación", "Se ha enviado un correo electrónico con las instrucciones para recuperar la contraseña.", SweetAlertIcon.Info);
